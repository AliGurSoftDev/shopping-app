...
const MenuBar = () => {
  ...
  const handleSearch = () => {
    if (searchTerm.trim()) {
      ...
      alert(`/products?search=${encodeURIComponent(searchTerm.trim())}`);
    ...
    <header className="w-full bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav className="hidden md:flex space-x-6 text-gray-700 font-medium">
          <a className="menu-link" href="/">Main Page</a>
          <a className="menu-link" href="/products">Products</a>
          <a className="menu-link" href="/categories">Categories</a>
          <a className="menu-link" href="/orders">Orders</a>
          <a className="menu-link" href="/cart">Cart</a>
          <a className="menu-link" href="/wishlist">Wishlist</a>
          <a className="menu-link" href="/account">Account</a>
        </nav>
